...
final class AutoFocusManager$AutoFocusTask$execute$2 extends Lambda implements Function1<Throwable, Unit> {
    public static final AutoFocusManager$AutoFocusTask$execute$2 INSTANCE = ;

    AutoFocusManager$AutoFocusTask$execute$2() {
    }
