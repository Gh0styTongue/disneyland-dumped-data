...
@SourceDebugExtension({"SMAP\nOneClickCheckoutFragment.kt\nKotlin\n*S Kotlin\n*F\n+ 1 OneClickCheckoutFragment.kt\ncom/disney/wdpro/oneclicklib/checkout/ui/OneClickCheckoutFragment$setUpUIData$2$3$1$1\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,303:1\n1#2:304\n*E\n"})
/* loaded from: classes3.dex */
final class OneClickCheckoutFragment$setUpUIData$2$3$1$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ CBReviewAndPurchaseScreen $this_run;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    OneClickCheckoutFragment$setUpUIData$2$3$1$1(CBReviewAndPurchaseScreen cBReviewAndPurchaseScreen) {
        super(0);
