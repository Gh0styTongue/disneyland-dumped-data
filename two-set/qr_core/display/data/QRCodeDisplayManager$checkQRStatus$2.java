...
@DebugMetadata(m92052c = "com.disney.wdpro.qr_core.display.data.QRCodeDisplayManager$checkQRStatus$2", m92053f = "QRCodeDisplayManager.kt", m92054i = {}, m92055l = {58}, m92056m = "invokeSuspend", m92057n = {}, m92058s = {})
/* loaded from: classes16.dex */
final class QRCodeDisplayManager$checkQRStatus$2 extends SuspendLambda implements Function2<InterfaceC30065h0, Continuation<? super QRStatus>, Object> {
    final /* synthetic */ AgeBand $ageBand;
    final /* synthetic */ String $primarySwid;
    int label;
    final /* synthetic */ QRCodeDisplayManager this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    QRCodeDisplayManager$checkQRStatus$2(QRCodeDisplayManager qRCodeDisplayManager, AgeBand ageBand, String str, Continuation<? super QRCodeDisplayManager$checkQRStatus$2> continuation) {
        super(2, continuation);
        this.this$0 = qRCodeDisplayManager;
        this.$ageBand = ageBand;
        this.$primarySwid = str;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new QRCodeDisplayManager$checkQRStatus$2(this.this$0, this.$ageBand, this.$primarySwid, continuation);
    }
    ...
    public final Object invoke(InterfaceC30065h0 interfaceC30065h0, Continuation<? super QRStatus> continuation) {
        return ((QRCodeDisplayManager$checkQRStatus$2) create(interfaceC30065h0, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}