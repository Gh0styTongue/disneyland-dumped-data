...
@DebugMetadata(m92052c = "com.disney.wdpro.qr_core.scan.ui.QRCodeScanViewModel$linkFriendByQrCode$1", m92053f = "QRCodeScanViewModel.kt", m92054i = {}, m92055l = {63}, m92056m = "invokeSuspend", m92057n = {}, m92058s = {})
/* loaded from: classes16.dex */
final class QRCodeScanViewModel$linkFriendByQrCode$1 extends SuspendLambda implements Function2<InterfaceC30065h0, Continuation<? super Unit>, Object> {
    ...
    QRCodeScanViewModel$linkFriendByQrCode$1(QRCodeScanViewModel qRCodeScanViewModel, AgeBand ageBand, String str, String str2, Continuation<? super QRCodeScanViewModel$linkFriendByQrCode$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new QRCodeScanViewModel$linkFriendByQrCode$1(this.this$0, this.$ageBand, this.$guid, this.$qrCode, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i10 == 0) {
                ...
                this.label = 1;
                Object objM60957l = qRCodeScanManager.m60957l(ageBand, str, str2, this);
                if (objM60957l == coroutine_suspended) {
    ...
    public final Object invoke(InterfaceC30065h0 interfaceC30065h0, Continuation<? super Unit> continuation) {
        return ((QRCodeScanViewModel$linkFriendByQrCode$1) create(interfaceC30065h0, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}