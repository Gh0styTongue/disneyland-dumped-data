...
final class VirtualQueueAnalytics$trackSelectQueuesLoad$queueList$1 extends Lambda implements Function1<Queue, CharSequence> {
    public static final VirtualQueueAnalytics$trackSelectQueuesLoad$queueList$1 INSTANCE = ;

    VirtualQueueAnalytics$trackSelectQueuesLoad$queueList$1() {
    }
