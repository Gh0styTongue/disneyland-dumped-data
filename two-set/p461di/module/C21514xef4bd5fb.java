...
/* renamed from: com.disney.wdpro.virtualqueue.core.di.module.DetailFragmentModule_ProvidesPositionAdapterFactory$virtual_queue_lib_releaseFactory */
/* loaded from: classes20.dex */
public final class C21514xef4bd5fb implements InterfaceC30583e<PositionAdapter.Factory> {
    ...
    public static C21514xef4bd5fb create(DetailFragmentModule detailFragmentModule, Provider<PicassoUtils> provider, Provider<VirtualQueueAnalytics> provider2, Provider<C9314j> provider3, Provider<FacilityUtils> provider4, Provider<Point> provider5, Provider<VirtualQueueThemer> provider6, Provider<DeepLinkConfig> provider7, Provider<PartyListAdapter.Factory> provider8) {
        return new C21514xef4bd5fb(detailFragmentModule, provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8);
    }

    public static PositionAdapter.Factory providesPositionAdapterFactory$virtual_queue_lib_release(DetailFragmentModule detailFragmentModule, PicassoUtils picassoUtils, VirtualQueueAnalytics virtualQueueAnalytics, C9314j c9314j, FacilityUtils facilityUtils, Point point, VirtualQueueThemer virtualQueueThemer, DeepLinkConfig deepLinkConfig, PartyListAdapter.Factory factory) {
        return (PositionAdapter.Factory) C30587i.m94207e(detailFragmentModule.providesPositionAdapterFactory$virtual_queue_lib_release(picassoUtils, virtualQueueAnalytics, c9314j, facilityUtils, point, virtualQueueThemer, deepLinkConfig, factory));
    }
