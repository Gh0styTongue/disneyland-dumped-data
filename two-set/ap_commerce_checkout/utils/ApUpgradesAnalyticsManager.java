...
public class ApUpgradesAnalyticsManager extends AnalyticsManager {
    ...
    public String getConfirmationState() {
        return TicketSalesAnalyticsConstants.ANNUAL_PASSES_UPGRADE_STATE_PURCHASE_CONFIRMATION;
    }

    @Override // com.disney.wdpro.base_sales_ui_lib.utils.AnalyticsManager
    public String getOrderSummaryState() {
        return TicketSalesAnalyticsConstants.ANNUAL_PASS_UPGRADE_STATE_CONFIRM_AND_PURCHASE;
    }
    ...
    public String getViewAndSignAgreementState() {
        return TicketSalesAnalyticsConstants.ANNUAL_PASS_UPGRADES_STATE_SIGN_AGREEMENT;
    }
}