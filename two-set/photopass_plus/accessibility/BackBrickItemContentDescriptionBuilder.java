...
@Metadata(m92037d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010%\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\f\u0018\u0000  2\u00020\u0001:\u0001 B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0006\u0010\u000b\u001a\u00020\u0000J\u000e\u0010\f\u001a\u00020\u00002\u0006\u0010\r\u001a\u00020\u0007J\u000e\u0010\u000e\u001a\u00020\u00002\u0006\u0010\u000f\u001a\u00020\u0007J\u0010\u0010\u0010\u001a\u00020\u00002\b\u0010\u0011\u001a\u0004\u0018\u00010\u0012J\u0010\u0010\u0013\u001a\u00020\u00002\b\u0010\u0014\u001a\u0004\u0018\u00010\u0015J\u000e\u0010\u0016\u001a\u00020\u00002\u0006\u0010\u0017\u001a\u00020\u0015J\u000e\u0010\u0018\u001a\u00020\u00002\u0006\u0010\u0019\u001a\u00020\u0015J\u001a\u0010\u001a\u001a\u00020\u00002\b\u0010\u001b\u001a\u0004\u0018\u00010\u00072\u0006\u0010\u001c\u001a\u00020\u0007H\u0002J\u0012\u0010\u001d\u001a\u00020\u00002\b\u0010\u001b\u001a\u0004\u0018\u00010\u0007H\u0002J\u0012\u0010\u001e\u001a\u00020\u00002\b\u0010\u001b\u001a\u0004\u0018\u00010\u0007H\u0002J\u0006\u0010\u001f\u001a\u00020\u0007R\u001a\u0010\u0005\u001a\u000e\u0012\u0004\u0012\u00020\u0007\u0012\u0004\u0012\u00020\u00070\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0012\u0010\b\u001a\u00060\tj\u0002`\nX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006!"}, m92038d2 = {"Lcom/disney/wdpro/photopass_plus/accessibility/BackBrickItemContentDescriptionBuilder;", "", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "brickValues", "", "", "stringBuilder", "Ljava/lang/StringBuilder;", "Lkotlin/text/StringBuilder;", "appendButtonSuffix", "appendCaptureDate", "date", "appendPositionInList", "positionInList", "appendPrice", "price", "Lcom/disney/wdpro/ticket_sales_base_lib/business/Price;", "appendProductCaption", "caption", "Landroid/text/Spanned;", "appendProductFullDescription", "fullDescription", "appendProductName", "name", "appendStringWithSeparator", "text", "separator", "appendWithCommaSeparator", "appendWithSpaceSeparator", "build", "Companion", "photopass-plus_release"}, m92039k = 1, m92040mv = {1, 8, 0}, m92042xi = 48)
/* loaded from: classes15.dex */
public final class BackBrickItemContentDescriptionBuilder {
    ...
    private final BackBrickItemContentDescriptionBuilder appendStringWithSeparator(String text, String separator) {
    ...
    private final BackBrickItemContentDescriptionBuilder appendWithCommaSeparator(String text) {
        return appendStringWithSeparator(text, ", ");
    }

    private final BackBrickItemContentDescriptionBuilder appendWithSpaceSeparator(String text) {
        return appendStringWithSeparator(text, " ");
    }

    public final BackBrickItemContentDescriptionBuilder appendButtonSuffix() {
    ...
    public final BackBrickItemContentDescriptionBuilder appendCaptureDate(String date) {
        Intrinsics.checkNotNullParameter(date, "date");
        this.brickValues.put(CAPTURE_DATE_KEY, date);
        return this;
    }

    public final BackBrickItemContentDescriptionBuilder appendPositionInList(String positionInList) {
        Intrinsics.checkNotNullParameter(positionInList, "positionInList");
        this.brickValues.put(POSITION_IN_LIST_KEY, positionInList);
        return this;
    }

    public final BackBrickItemContentDescriptionBuilder appendPrice(Price price) {
    ...
    public final BackBrickItemContentDescriptionBuilder appendProductCaption(Spanned caption) {
    ...
    public final BackBrickItemContentDescriptionBuilder appendProductFullDescription(Spanned fullDescription) {
        Intrinsics.checkNotNullParameter(fullDescription, "fullDescription");
        this.brickValues.put(PRODUCT_FULL_DESCRIPTION_KEY, fullDescription.toString());
        return this;
    }

    public final BackBrickItemContentDescriptionBuilder appendProductName(Spanned name) {
