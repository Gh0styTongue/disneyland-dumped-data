...
public final class DownScreenFragment_MembersInjector implements MembersInjector<DownScreenFragment> {
    ...
    public static void injectConfiguration(DownScreenFragment downScreenFragment, UniversalCheckoutConfiguration universalCheckoutConfiguration) {
        downScreenFragment.configuration = universalCheckoutConfiguration;
    }
